...
var defaultItems = []seedItem{
	...
	{
		Title:         "Breaking Bad",
		Description:   "A chemistry teacher turns to manufacturing methamphetamine, pulling his family and partner into a dangerous criminal world.",
		Type:          "tv_show",
		CoverImage:    "https://img.youtube.com/vi/HhesaQXLuRY/hqdefault.jpg",
		ContentLink:   "https://www.youtube.com/watch?v=HhesaQXLuRY",
		ReleaseDate:   "2008-01-20",
		Director:      "Vince Gilligan",
		Duration:      47,
		Rating:        9.5,
		CategorySlugs: []string{"crime", "drama", "thriller"},
	},
	{
		Title:         "Stranger Things",
		Description:   "Kids in Hawkins uncover secret experiments, supernatural threats, and a parallel dimension called the Upside Down.",
		Type:          "tv_show",
		CoverImage:    "https://img.youtube.com/vi/b9EkMc79ZSU/hqdefault.jpg",
		ContentLink:   "https://www.youtube.com/watch?v=b9EkMc79ZSU",
		ReleaseDate:   "2016-07-15",
		Director:      "The Duffer Brothers",
		Duration:      50,
		Rating:        8.7,
		CategorySlugs: []string{"sci-fi", "horror", "mystery", "adventure"},
	},
	{
		Title:         "The Last of Us",
		Description:   "Joel and Ellie cross a devastated America where survival depends on trust, grief, and impossible choices.",
		Type:          "tv_show",
		CoverImage:    "https://img.youtube.com/vi/uLtkt8BonwM/hqdefault.jpg",
		ContentLink:   "https://www.youtube.com/watch?v=uLtkt8BonwM",
		ReleaseDate:   "2023-01-15",
		Director:      "Craig Mazin, Neil Druckmann",
		Duration:      56,
		Rating:        8.8,
		CategorySlugs: []string{"drama", "horror", "adventure"},
	},
	{
		Title:         "The Mandalorian",
		Description:   "A lone bounty hunter protects a mysterious child while navigating the outer reaches of the Star Wars galaxy.",
		Type:          "tv_show",
		CoverImage:    "https://img.youtube.com/vi/aOC8E8z_ifw/hqdefault.jpg",
		ContentLink:   "https://www.youtube.com/watch?v=aOC8E8z_ifw",
		ReleaseDate:   "2019-11-12",
		Director:      "Jon Favreau",
		Duration:      40,
		Rating:        8.6,
		CategorySlugs: []string{"sci-fi", "adventure", "action"},
	},
	{
		Title:         "Dark",
		Description:   "A missing child exposes time loops, family secrets, and a knot of events connecting four generations in a German town.",
		Type:          "tv_show",
		CoverImage:    "https://img.youtube.com/vi/rrwycJ08PSA/hqdefault.jpg",
		ContentLink:   "https://www.youtube.com/watch?v=rrwycJ08PSA",
		ReleaseDate:   "2017-12-01",
		Director:      "Baran bo Odar, Jantje Friese",
		Duration:      53,
		Rating:        8.7,
		CategorySlugs: []string{"sci-fi", "mystery", "thriller", "psychological"},
	},
	{
