...
const translations = {
  en: {
    ...
    admin: {
      ...
      dashboardSubtitle: "Manage catalog content — categories, items, and the full library.",
  ...
  ar: {
    ...
    admin: {
      ...
      dashboardSubtitle: "إدارة محتوى المنصة — التصنيفات والعناصر والمكتبة بالكامل.",
