...
const translations = {
  en: {
    ...
    watchLater: {
      ...
      kicker: "Your queue",
      heading: "Watch Later",
      subtitle: "Movies, games, and books you want to get to soon.",
    ...
    lists: {
      ...
      heading: "My Lists",
      subtitle: "Create custom lists and organize movies, games, and books.",
  ...
  ar: {
    ...
    watchLater: {
      ...
      subtitle: "الأفلام والألعاب والكتب التي تريد مشاهدتها قريباً.",
    ...
    lists: {
      ...
      kicker: "مجموعاتك",
      heading: "قوائمي",
      subtitle: "أنشئ قوائم مخصصة ونظّم الأفلام والألعاب والكتب.",
